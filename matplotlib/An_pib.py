...
class abertura_pib():
    def __init__(self):
        ...
        layout = [
            ...
            [pg.Image(filename=self.n,size=(200,200),key='tt')]
    ...
    def start(self):
        ...
        layout = [
            [pg.Text('Digite os nomes dos paises para comparar o PIB')],
            [pg.Input(size=(20,0),key='paises'),pg.Button('Iniciar')],
            [pg.Image(filename='matplotlib/dados/teste1.png')]
            #[pg.Output(size=(60,40))]
        ]
        self.janela = pg.Window('comparação de PIB').layout(layout)
        ...
        while True:
            ...
            plt.legend()#para colocar legenda
            fig = plt.gcf()

            fig.savefig('matplotlib/dados/teste1.png',format='png')
            self.nome='matplotlib/dados/teste1.png'
